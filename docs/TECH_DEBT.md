...
English version: `docs/TECH_DEBT.en.md`.
...
- **Файлы и примерные строки:** `ui/game/hud/windows/inventory_hud.gd` (стр. 768–774) — повторная попытка из-за потенциальной неготовности DataDB.【F:ui/game/hud/windows/inventory_hud.gd†L768-L774】
- **Категория:** архитектура
- **Уровень риска:** средний
...
5. **Проблемы инициализации DataDB, ретраи в UI** (средний риск скрытых ошибок).【F:ui/game/hud/windows/inventory_hud.gd†L768-L774】
