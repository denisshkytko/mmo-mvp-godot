...
@onready var list: ItemList = $Center/Panel/Margin/VBox/CharacterList
@onready var delete_button: Button = $Center/Panel/Margin/VBox/Buttons/DeleteButton
@onready var enter_button: Button = $Center/Panel/Margin/VBox/Buttons/EnterButton
@onready var logout_button: Button = $Center/Panel/Margin/VBox/Buttons/LogoutButton
