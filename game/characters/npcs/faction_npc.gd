...
const MERCHANT_MODEL_SCENE := preload("res://game/characters/models/npcs/MerchantModel.tscn")
const TRAINER_MODEL_SCENE := preload("res://game/characters/models/npcs/TrainerModel.tscn")
